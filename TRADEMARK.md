# Crosscode trademark policy

The Crosscode **code** is MIT licensed. The MIT License is a copyright licence:
it does not grant any rights in the **name** "Crosscode" or in the logos under
[`assets/`](./assets). Those are separate, and this page says what you can do
with them. The short version: describe your relationship to Crosscode however
you like, just don't claim to *be* Crosscode.
...
- **Don't present a modified version as Crosscode.** If you change the code,
  change the name. A fork that ships broken and calls itself Crosscode costs
  users their trust in a project they didn't actually run.
...
Anything not covered above, ask: **legal@getcrosscode.dev**. Say what you want
to use and where. Requests that help users find the real project are usually
easy yeses.
...
If you think something in this policy is unreasonable, open an issue. It is
meant to stop impersonation, nothing more.
